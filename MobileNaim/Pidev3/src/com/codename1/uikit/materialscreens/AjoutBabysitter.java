...
public class AjoutBabysitter extends SideMenuBaseForm {
   ...
   //  Home y=new Home(theme);
      ...
      ComboBox t=new ComboBox("NaimE2","NaimP5");
       ...
       // affiche.addActionListener(e -> new afficheBabysitting(res,this.u).getAfficheBabysitting().show());
        ...
        {s+=" vendredi";}
                        int w = 15;
                           ...
                           int ee= (int) timePicker.getValue()/60;
                           String ss=Integer.toString(ee);
                          System.out.println("value: "+ss);
                         // TimeZone.getTimeZone("GMT-"+ss+":00").getRawOffset()
                         Babysitting t = new Babysitting(w, (int) timePicker.getValue() ,(int) timePicker1.getValue(),s,Integer.parseInt(tx_prixheure.getText()),new Enfant(7));
                         ServiceBabysitting.getInstance().AjoutBabysitter(t,w);
                        Dialog.show("Success","Connection accepted",new Command("OK"));
           
                         
                    
        }
       if(o.toString()=="NaimP5"){
              String s="";
        if(lundi.isSelected())
                { s+="lundi";}
        if(mardi.isSelected())
        ...
        {s+=" vendredi";}
                        int k = 16;
                         Babysitting t = new Babysitting(k, (int) timePicker.getValue(),(int) timePicker1.getValue(),s,Integer.parseInt(tx_prixheure.getText()),new Enfant(7));
                         ServiceBabysitting.getInstance().AjoutBabysitter(t,k);
