...
class UserRepository extends EntityRepository
{
    ...
    public function AfficherBabysitter()
    {
        $q=$this->getEntityManager()->createQuery('SELECT u FROM PidevBundle:user u where u.typeemploye = :typeemploye ')
            ->setParameter("typeemploye","BabySitter");
        return $q->getResult();
    }

    public function AfficherNomBabysitter($username)
    {
        $q=$this->getEntityManager()->createQuery('SELECT u FROM PidevBundle:user u where u.username = :username ');
        $q->setParameter('username',$username);
        return $q->getResult();
    }
    public function AfficherBabysitterParId($id)
    {
        $q=$this->getEntityManager()->createQuery('SELECT u FROM PidevBundle:user u where u.id = :id ');
