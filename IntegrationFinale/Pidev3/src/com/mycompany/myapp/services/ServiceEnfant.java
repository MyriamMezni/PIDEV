...
public class ServiceEnfant {
    ...
    public ArrayList<Enfant> Enfant;
     public ArrayList<Enfant> NomEnfant;
      public ArrayList<Enfant> NomEnfantAffiche;
...
//                String get = obj.get("idParent").toString();
    ...
    public ArrayList<Enfant> getNomEnfants(int id){
        ...
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            public void actionPerformed(NetworkEvent evt) {
                ServiceEnfant ser = new ServiceEnfant();
                Enfant=ser.parseListReclamationJson(new String(req.getResponseData()));
                req.removeResponseListener(this);
            }
        });
        NetworkManager.getInstance().addToQueueAndWait(req);
        NomEnfant=new ArrayList<>();
       
        
            
                NomEnfant.add(Enfant.get(0));
            
        
        return Enfant;
    }
     public Enfant getIdEnfant(String nom){
        String url = "http://localhost/PidevF2/Pidev/web/app_dev.php/Pidev/parsingNomEnfantDisplay/"+nom;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
     ...
     public Enfant getNomEnfant(int id){
        String url = "http://localhost/PidevF2/Pidev/web/app_dev.php/Pidev/parsingNomEnfantParId/"+id;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
        ...
        NetworkManager.getInstance().addToQueueAndWait(req);
        NomEnfantAffiche=new ArrayList<>();
       
        
            
                NomEnfantAffiche.add(Enfant.get(0));
