...
public class Menu {
    ...
    public Menu(int id, String nom, String image, String description, String jour_de_la_semaine) {
        this.id = id;
        this.nom = nom;
        this.image = image;
    ...
    public Menu(String nom, String image, String description, String jour_de_la_semaine) {
        this.nom = nom;
        this.image = image;
        this.description = description;
        this.jour_de_la_semaine = jour_de_la_semaine;
