...
public class User {
    ...
    public static void main(String[] args) {
      ...
      for(Parent p:ps.triTarif())
      {
        ...
        System.out.println(ControleSaisie.valiEmail("ok@o.co"));
        System.out.println(ControleSaisie.isNumber(""));
        System.out.println(ControleSaisie.isString(" o"));
        String test="  ";
        System.out.println(test.trim());
        System.out.println(ControleSaisie.isString(test));
        System.out.println(ControleSaisie.validPassword("o910Oabcdeft.*@#"));
        System.out.println(ControleSaisie.adresse(" "));
    }
