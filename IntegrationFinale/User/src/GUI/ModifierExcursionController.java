 ...
 * @author ASUS
 */
public class ModifierExcursionController implements Initializable {
   ...
   private ComboBox<String> txtType;
    ObservableList<String> list1=FXCollections.observableArrayList("Excursion");
    @FXML
    ...
    private void modifier(ActionEvent event) {
        ...
        try {
            ...
            ES.update(new Excurtion(txtDepart.getText(), txtDestination.getText(), val, txtCapacite.getValue(), txtNom.getText(), txtHeure.getValue().toString(), txtDescription.getText() , txtDate.getValue().toString(), chemin, txtType.getValue()));
