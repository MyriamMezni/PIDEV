    ...
    public function AjouterMenuBackAction(Request $request)
    {
        if($this->getUser()!=null)
        {
            if($this->getUser()->getRole()=="Employe" or $this->getUser()->getRole()=="Admin")
            {
                ...
                return $this->render("@Pidev/Menu/Back/AjouterMenu.html.twig",array("form"=>$form->createView(),"erreur"=>$erreur));
    ...
    public function ModifierMenuBackAction(Request $request,$idMenu)
    {
        if($this->getUser()!=null)
        {
            if($this->getUser()->getRole()=="Employe" or $this->getUser()->getRole()=="Admin")
            {
                ...
                return $this->render("@Pidev/Menu/Back/ModifierMenu.html.twig",array("form"=>$form->createView(),"erreur"=>$erreur));
